                ...
                itemBuilder: (BuildContext context, int index) => ListTile(
                  trailing: PopupMenuButton(
                    ...
                    onSelected: (_ItemActions action) =>
                        _perfomAction(action, _items[index], context),
    ...
    switch (action) {
      ...
      case _ItemActions.edit:
        ...
        final result = await showDialog<String>(
          context: context,
          builder: (context) => _EditItemsWidget(item.value),
        );
        if (result != null) {
          await _storage.write(
              key: item.key,
...
class _EditItemsWidget extends StatelessWidget {
  _EditItemsWidget(String text)
